    ...
    <div class="col-md-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form id="formCita" action="{{ route('citas.update', $cita) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="user_id" class="form-control" required>
                            ...
                            @foreach ($barberos as $barbero)
                                <option value="{{ $barbero->id }}"{{ $cita->user_id == $barbero->id ? 'selected' : '' }}>
                                    {{ $barbero->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="fecha" id="fecha" class="form-control" value="{{ \Carbon\Carbon::parse($cita->fecha)->format('Y-m-d') }}"required>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="time" id="hora" name="hora" class="form-control" value="{{ \Carbon\Carbon::parse($cita->hora)->format('H:i') }}"required>
